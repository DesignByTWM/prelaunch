 ...
 *
 * ============================================================
 * SOURCE: Liz's Featured Builds mock, August 14 2026
 * ============================================================
 * The six builds below are the six she named, with her vehicle,
 * her build title and her discipline pairings used verbatim.
 * These replaced three invented builds on August 17 2026 per Jose.
 *
 * WHAT IS HERS, AND THEREFORE TREATED AS FACT:
 *   vehicle, title, tags, type
 *
 * WHAT IS OURS, AND THEREFORE STILL DRAFT:
 *   brief, stages[].detail, outcome
 ...
 *   - Confirmation these six are real completed builds
 *   - Real photography, promised by Liz on August 14
 *   - Written owner permission where a vehicle is identifiable
 *
 * Tracked in CLIENT_REVIEW_NOTES.md sections 8, 17 and 21.
 *
...
export const featuredBuilds: FeaturedBuild[] = [
  {
    ...
    gallery: [
      { src: "/svc-blackout.webp", alt: "Blackout trim detail" },
      { src: "/svc-wheels.webp", alt: "Wheel and fitment detail" },
      { src: "/mat-stitch.webp", alt: "Interior stitching detail" },
    ],
    placeholder: true,
  },
  {
    ...
    gallery: [
      { src: "/svc-wraps.webp", alt: "Wrap finish detail" },
      { src: "/wheel-2.webp", alt: "Wheel detail" },
      { src: "/mat-fitment.webp", alt: "Fitment detail" },
    ],
    placeholder: true,
  },
  {
    ...
    gallery: [
      ...
      { src: "/mat-metal.webp", alt: "Finish detail" },
    ],
    placeholder: true,
  },
  {
    ...
    gallery: [
      { src: "/svc-interior.webp", alt: "Interior retrim detail" },
  ...
  },
  {
    ...
    gallery: [
      { src: "/svc-ppf.webp", alt: "Paint protection film detail" },
